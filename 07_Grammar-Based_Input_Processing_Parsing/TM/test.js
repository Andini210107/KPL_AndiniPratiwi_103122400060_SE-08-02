...
test.describe('Pemrosesan untuk brave.com', () => {
    ...
    const brave = fs.readFileSync(__dirname + '/daftar/brave.txt', 'utf-8');
...
test.describe('Pemrosesan untuk mikrotik.com', () => {
    ...
    const mikrotik = fs.readFileSync(__dirname + '/daftar/mikrotik.txt', 'utf-8');
...
test.describe('Pemrosesan untuk openai.com', () => {
    ...
    const openai = fs.readFileSync(__dirname + '/daftar/openai.txt', 'utf-8');
...
test.describe('Pemrosesan untuk lazada.com', () => {
    ...
    const lazada = fs.readFileSync(__dirname + '/daftar/lazada.txt', 'utf-8');
...
test.describe('Pemrosesan untuk kemenag.go.id', () => {
    ...
    const kemenag = fs.readFileSync(__dirname + '/daftar/kemenag.txt', 'utf-8');
    ...
    test.it('Ada beberapa laman yang tidak boleh dirayapi oleh Bingbot', () => {
        assert.deepStrictEqual(
            result.agents['bingbot'].Disallow,
            ["/api/", "/_next/"]
        );
    });
